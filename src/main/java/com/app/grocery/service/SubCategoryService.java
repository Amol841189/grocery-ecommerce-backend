...
public class SubCategoryService {
  ...
  @Transactional
  public SubCategoryResponse addSubCategory(SubCategoryCreateRequest request) {
    // ==========================================
    // 1. FIND CATEGORY
    // ==========================================
    ...
    boolean exists = subCategoryRepository.existsByNameIgnoreCaseAndCategory_CategoryId(
      request.getName(),
    ...
    subCategory.setSubCategoryId(SubCategoryIdGenerator.generate());
  ...
  public SubCategoryResponse updateSubCategory(
    ...
    if (exists && !subCategory.getName().equalsIgnoreCase(request.getName())) {
      throw new RuntimeException("SubCategory already exists in this category");
    }
